...
@Component({
  ...
  styleUrls: ['./editamount.component.css']
})
        ...
        if (searchQuery) {
          if (searchQuery.length > 12) {
            ...
            this.fiterdata = this.shareData.filter((data: any) => {
              return (
                data.customerAccountNumber.toLowerCase().includes(searchQuery.toLowerCase()) &&
